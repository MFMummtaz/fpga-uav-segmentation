...
class Options():
    def __init__(self):
        ...
        parser.add_argument('--start-features', type=int, default=16, help='initial unet features')
        ...
        parser.add_argument('--weight-decay', type=float, default=5e-6, metavar='M', help='w-decay (default: 5e-6)')
