...
from models.custom_light_2 import Novelty_ULite
...
if __name__ == "__main__":
    ...
    # Config setup
    config = OmegaConf.load('./models/config/config_ulite2_custom.yaml')
    ...
    #                    upsample=model_cfg.is_upsample).to(device=device)
